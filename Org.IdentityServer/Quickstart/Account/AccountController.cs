...
namespace IdentityServer4.Quickstart.UI
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Login(LoginInputModel model, string button)
        {
            ...
            {
                var result = await _signInManager.PasswordSignInAsync(model.EmailAddress, model.Password, model.RememberLogin, lockoutOnFailure: true);
                if (result.Succeeded)
                {
                ...
                await _events.RaiseAsync(new UserLoginFailureEvent(model.EmailAddress, "invalid credentials", clientId:context?.ClientId));
